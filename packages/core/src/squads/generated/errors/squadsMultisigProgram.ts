...
let squadsMultisigProgramErrorMessages: Record<SquadsMultisigProgramError, string> | undefined;
...
export function getSquadsMultisigProgramErrorMessage(code: SquadsMultisigProgramError): string {
  if (process.env["NODE_ENV"] !== "production") {
    return (squadsMultisigProgramErrorMessages as Record<SquadsMultisigProgramError, string>)[code];
  }

  return "Error message not available in production bundles.";
}

export function isSquadsMultisigProgramError<TProgramErrorCode extends SquadsMultisigProgramError>(
  error: unknown,
  transactionMessage: {
