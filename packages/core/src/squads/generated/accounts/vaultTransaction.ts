...
export const VAULT_TRANSACTION_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  168, 250, 162, 100, 81, 14, 162, 207,
]);

export function getVaultTransactionDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VAULT_TRANSACTION_DISCRIMINATOR);
}
...
export function getVaultTransactionCodec(): Codec<VaultTransactionArgs, VaultTransaction> {
...
): Account<VaultTransaction, TAddress> | MaybeAccount<VaultTransaction, TAddress> {
...
export async function fetchMaybeVaultTransaction<TAddress extends string = string>(
  rpc: Parameters<typeof fetchEncodedAccount>[0],
  address: Address<TAddress>,
  config?: FetchAccountConfig,
