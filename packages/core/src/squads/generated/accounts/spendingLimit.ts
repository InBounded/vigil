...
export function getSpendingLimitDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SPENDING_LIMIT_DISCRIMINATOR);
}
...
export function getSpendingLimitCodec(): Codec<SpendingLimitArgs, SpendingLimit> {
...
export function decodeSpendingLimit<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getSpendingLimitDecoder());
}
