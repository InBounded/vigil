...
export function getVaultTransactionMessageEncoder(): Encoder<VaultTransactionMessageArgs> {
  return getStructEncoder([
    ...
    ["addressTableLookups", getArrayEncoder(getMultisigMessageAddressTableLookupEncoder())],
  ]);
}
...
export function getVaultTransactionMessageDecoder(): Decoder<VaultTransactionMessage> {
  return getStructDecoder([
    ...
    ["addressTableLookups", getArrayDecoder(getMultisigMessageAddressTableLookupDecoder())],
  ]);
}
