...
export function getConfigActionEncoder(): Encoder<ConfigActionArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    ["RemoveSpendingLimit", getStructEncoder([["spendingLimit", getAddressEncoder()]])],
    [
      "SetRentCollector",
      getStructEncoder([["newRentCollector", getOptionEncoder(getAddressEncoder())]]),
    ],
  ]);
}
...
export function getConfigActionDecoder(): Decoder<ConfigAction> {
  return getDiscriminatedUnionDecoder([
    ...
    ["RemoveSpendingLimit", getStructDecoder([["spendingLimit", getAddressDecoder()]])],
    [
      "SetRentCollector",
      getStructDecoder([["newRentCollector", getOptionDecoder(getAddressDecoder())]]),
    ],
  ]);
}
...
export function configAction(
  kind: "AddMember",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "AddMember">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "AddMember">;
export function configAction(
  kind: "RemoveMember",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "RemoveMember">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "RemoveMember">;
export function configAction(
  kind: "ChangeThreshold",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "ChangeThreshold">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "ChangeThreshold">;
export function configAction(
  kind: "SetTimeLock",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "SetTimeLock">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "SetTimeLock">;
export function configAction(
  kind: "AddSpendingLimit",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "AddSpendingLimit">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "AddSpendingLimit">;
export function configAction(
  kind: "RemoveSpendingLimit",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "RemoveSpendingLimit">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "RemoveSpendingLimit">;
export function configAction(
  kind: "SetRentCollector",
  data: GetDiscriminatedUnionVariantContent<ConfigActionArgs, "__kind", "SetRentCollector">,
): GetDiscriminatedUnionVariant<ConfigActionArgs, "__kind", "SetRentCollector">;
export function configAction<K extends ConfigActionArgs["__kind"], Data>(kind: K, data?: Data) {
