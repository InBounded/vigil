...
export function getProposalStatusCodec(): Codec<ProposalStatusArgs, ProposalStatus> {
...
export function proposalStatus(
  kind: "Draft",
  data: GetDiscriminatedUnionVariantContent<ProposalStatusArgs, "__kind", "Draft">,
): GetDiscriminatedUnionVariant<ProposalStatusArgs, "__kind", "Draft">;
export function proposalStatus(
  kind: "Active",
  data: GetDiscriminatedUnionVariantContent<ProposalStatusArgs, "__kind", "Active">,
): GetDiscriminatedUnionVariant<ProposalStatusArgs, "__kind", "Active">;
export function proposalStatus(
  kind: "Rejected",
  data: GetDiscriminatedUnionVariantContent<ProposalStatusArgs, "__kind", "Rejected">,
): GetDiscriminatedUnionVariant<ProposalStatusArgs, "__kind", "Rejected">;
export function proposalStatus(
  kind: "Approved",
  data: GetDiscriminatedUnionVariantContent<ProposalStatusArgs, "__kind", "Approved">,
...
export function proposalStatus(
  kind: "Executed",
  data: GetDiscriminatedUnionVariantContent<ProposalStatusArgs, "__kind", "Executed">,
): GetDiscriminatedUnionVariant<ProposalStatusArgs, "__kind", "Executed">;
export function proposalStatus(
  kind: "Cancelled",
  data: GetDiscriminatedUnionVariantContent<ProposalStatusArgs, "__kind", "Cancelled">,
): GetDiscriminatedUnionVariant<ProposalStatusArgs, "__kind", "Cancelled">;
export function proposalStatus<K extends ProposalStatusArgs["__kind"], Data>(kind: K, data?: Data) {
