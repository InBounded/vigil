...
export const PROPOSAL_CANCEL_V2_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  205, 41, 194, 61, 220, 139, 16, 247,
]);

export function getProposalCancelV2DiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(PROPOSAL_CANCEL_V2_DISCRIMINATOR);
}
