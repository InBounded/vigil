...
export const VAULT_TRANSACTION_CREATE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  48, 250, 78, 168, 208, 226, 218, 211,
]);

export function getVaultTransactionCreateDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VAULT_TRANSACTION_CREATE_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getVaultTransactionCreateInstructionDataDecoder().decode(instruction.data),
  };
}
