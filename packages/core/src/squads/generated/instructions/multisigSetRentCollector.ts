...
export const MULTISIG_SET_RENT_COLLECTOR_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  48, 204, 65, 57, 210, 70, 156, 74,
]);

export function getMultisigSetRentCollectorDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_SET_RENT_COLLECTOR_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getMultisigSetRentCollectorInstructionDataDecoder().decode(instruction.data),
  };
}
