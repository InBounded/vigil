...
export const MULTISIG_REMOVE_MEMBER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  217, 117, 177, 210, 182, 145, 218, 72,
]);

export function getMultisigRemoveMemberDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_REMOVE_MEMBER_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getMultisigRemoveMemberInstructionDataDecoder().decode(instruction.data),
  };
}
