...
export const MULTISIG_SET_TIME_LOCK_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  148, 154, 121, 77, 212, 254, 155, 72,
]);

export function getMultisigSetTimeLockDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_SET_TIME_LOCK_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getMultisigSetTimeLockInstructionDataDecoder().decode(instruction.data),
  };
}
