...
export function getProposalCancelDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(PROPOSAL_CANCEL_DISCRIMINATOR);
}
...
>(
  input: ProposalCancelInput<TAccountMultisig, TAccountMember, TAccountProposal>,
