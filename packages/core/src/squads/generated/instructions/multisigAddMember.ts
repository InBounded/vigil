...
export const MULTISIG_ADD_MEMBER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  1, 219, 215, 108, 184, 229, 214, 8,
]);

export function getMultisigAddMemberDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_ADD_MEMBER_DISCRIMINATOR);
}
