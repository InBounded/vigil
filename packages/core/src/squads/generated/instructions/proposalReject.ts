...
export function getProposalRejectDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(PROPOSAL_REJECT_DISCRIMINATOR);
}
...
>(
  input: ProposalRejectInput<TAccountMultisig, TAccountMember, TAccountProposal>,
