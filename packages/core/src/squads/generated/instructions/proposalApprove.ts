...
export const PROPOSAL_APPROVE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  144, 37, 164, 136, 188, 216, 42, 248,
]);

export function getProposalApproveDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(PROPOSAL_APPROVE_DISCRIMINATOR);
}
...
>(
  input: ProposalApproveInput<TAccountMultisig, TAccountMember, TAccountProposal>,
