...
export const CONFIG_TRANSACTION_ACCOUNTS_CLOSE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
...
>(
  ...
  return {
    ...
    data: getConfigTransactionAccountsCloseInstructionDataDecoder().decode(instruction.data),
  };
}
