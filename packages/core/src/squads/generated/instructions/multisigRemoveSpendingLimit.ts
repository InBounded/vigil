...
export const MULTISIG_REMOVE_SPENDING_LIMIT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  228, 198, 136, 111, 123, 4, 178, 113,
]);

export function getMultisigRemoveSpendingLimitDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_REMOVE_SPENDING_LIMIT_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getMultisigRemoveSpendingLimitInstructionDataDecoder().decode(instruction.data),
  };
}
