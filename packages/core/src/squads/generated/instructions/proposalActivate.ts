...
export const PROPOSAL_ACTIVATE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  11, 34, 92, 248, 154, 27, 51, 106,
]);

export function getProposalActivateDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(PROPOSAL_ACTIVATE_DISCRIMINATOR);
}
...
>(
  input: ProposalActivateInput<TAccountMultisig, TAccountMember, TAccountProposal>,
  ...
  ResolvedInstructionAccountMeta<TAccountProposal, InstructionAccountInputAddress<TAccountProposal>>
> {
  // Program address.
  ...
  const originalAccounts = {
    ...
    member: { value: input.member ?? null, isSigner: true, isWritable: true },
    proposal: {
