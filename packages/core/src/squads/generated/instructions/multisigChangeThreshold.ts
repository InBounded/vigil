...
export const MULTISIG_CHANGE_THRESHOLD_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  141, 42, 15, 126, 169, 92, 62, 181,
]);

export function getMultisigChangeThresholdDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_CHANGE_THRESHOLD_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getMultisigChangeThresholdInstructionDataDecoder().decode(instruction.data),
  };
}
