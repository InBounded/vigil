...
export const MULTISIG_SET_CONFIG_AUTHORITY_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  143, 93, 199, 143, 92, 169, 193, 232,
]);

export function getMultisigSetConfigAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MULTISIG_SET_CONFIG_AUTHORITY_DISCRIMINATOR);
}
...
>(
  ...
  return {
    ...
    data: getMultisigSetConfigAuthorityInstructionDataDecoder().decode(instruction.data),
  };
}
